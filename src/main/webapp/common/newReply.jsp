	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">		
				<form action="/replyWrite" method="post" id="frmInsert" enctype="multipart/form-data">
					...
					<input type="hidden" id="w_no" name="w_no" value="${w_no}">
					<input type="hidden" id="w_gno" name="w_gno" value="${w_gno}">					
					<div class="form-group">
