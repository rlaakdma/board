...
<body>
	...
	<div class="container">
		...
		<form class="form-signin" action="/loginServlet" method="post">
			...
			<label for="StudentId" class="sr-only">userId</label>
			<%
// 				String userId = request.getParameter("userId");
// 					userId = userId == null? "" : userId;
			%>
			<input type="text"
				id="studentId" name="studentId" class="form-control" placeholder="userId"
				required autofocus value="${param.studentId}"> <label for="Pass" class="sr-only">Password</label>
